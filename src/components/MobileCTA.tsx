    ...
    >
      <div className="relative">
        ...
        <button
          ...
          className="absolute -top-2 -right-2 w-6 h-6 bg-[#128C7E] text-white rounded-full flex items-center justify-center shadow-lg hover:bg-[#075E54] transition-colors"
          aria-label="Dismiss"
        >
          <X className="w-3 h-3" />
        </button>
